...
export const translations = {
  pt: {
    ...
    about: {
      ...
      outside: 'Moro em São Francisco Xavier, na Serra da Mantiqueira. Toco no Maracatu Baque do Xico, ajudo a organizar círculos de consciência política e colaboro em projetos de ativismo que conectam tecnologia e causas progressistas.',
      f1k: '2012—19',
      f1v: 'Co-fundador & CTO',
      f1s: 'Grubster · #1 Food, App Store BR',
      f2k: '2018',
      f2v: 'Integração de M&A',
      f2s: 'Fusão com ChefsClub',
      f3k: '2019—25',
      f3v: 'Fullstack sênior',
      f3s: 'Tesorio · fintech YC, EUA',
      f4k: '2025—',
      f4v: 'Independente',
    ...
    terminal: {
      lines: ['Produto do zero', 'Sprint de entrega', 'AI enablement'],
    },
    contact: {
  ...
  en: {
    ...
    about: {
      ...
      outside: 'I live in São Francisco Xavier, in the Mantiqueira Mountains. I play in the Maracatu Baque do Xico, help organize political consciousness circles, and collaborate on activism projects connecting technology and progressive causes.',
      f1k: '2012—19',
      f1v: 'Co-founder & CTO',
      f1s: 'Grubster · #1 Food, BR App Store',
      f2k: '2018',
      f2v: 'M&A integration',
      f2s: 'Merger with ChefsClub',
      f3k: '2019—25',
      f3v: 'Senior fullstack',
      f3s: 'Tesorio · YC fintech, US',
      f4k: '2025—',
      f4v: 'Independent',
    ...
    terminal: {
      lines: ['Product from zero', 'Delivery sprint', 'AI enablement'],
    },
    contact: {
